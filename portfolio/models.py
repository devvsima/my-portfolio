...
class Project(models.Model):
    ...
    preview_image = models.ImageField(upload_to='projects/preview/', verbose_name="Превью изображение", null=True, blank=True)
...
class Skill(models.Model):
    name = models.CharField(max_length=100, verbose_name="Название")
    icon = models.CharField(max_length=100, verbose_name="Иконка (CSS класс)", null=True, blank=True)
